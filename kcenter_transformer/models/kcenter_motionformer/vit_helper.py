...
def load_pretrained(
    ...
    #  Load state dict
    assert (f"{cfg.KCENTER_MOTIONFORMER.PRETRAINED_WEIGHTS} not in [vit_1k, vit_1k_large]")
    state_dict = torch.hub.load_state_dict_from_url(url=default_cfgs[cfg.KCENTER_MOTIONFORMER.PRETRAINED_WEIGHTS])
