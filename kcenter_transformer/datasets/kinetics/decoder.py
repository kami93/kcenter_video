...
def get_start_end_idx(video_size, clip_size, clip_idx, num_clips, seed=None):
    """
...
def pyav_decode(
    container, sampling_rate, num_frames, clip_idx, num_clips=10, target_fps=30, seed=None
):
    """
...
def decode(
    ...
    try:
        if backend == "pyav":
            ...
            raise NotImplementedError(
                "We do not support {}".format(backend)
            )
    ...
    # note that decode_all_video is False for noraml videos!
